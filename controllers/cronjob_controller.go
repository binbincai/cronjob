...
import (
	...
	batch "github.com/binbincai/cronjob/api/v1"
...
var (
	scheduledTimeAnnotation = "batch.github.com/scheduled-at"
)
...
func (r *CronJobReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	result := ctrl.Result{RequeueAfter: nextRun.Sub(r.Now())} // save this so we can re-use it elsewhere
